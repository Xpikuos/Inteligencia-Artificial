...
namespace XudonV2NetStandard.XCells
{
    public class XCellFDown : XCell
    {
        ...
        public XCellFDown(Layer layer) :base(layer) { }
        public XCellFDown(string id, Layer layer) : base(id, layer) { }

        public XCellFDown(uint resolution, Layer layer) : base(layer)
        {
