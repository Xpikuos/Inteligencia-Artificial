...
{
    public class XCellFEqual : XCell
    {
        ...
        public XCellFEqual(Layer layer) :base(layer) { }
        public XCellFEqual(string id, Layer layer) : base(id, layer) { }

        public XCellFEqual(uint resolution, Layer layer) : base(layer)
        {
        ...
        public uint GetMappedInputValue(double input)
        {
