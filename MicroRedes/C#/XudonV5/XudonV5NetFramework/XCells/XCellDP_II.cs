...
{
    public class XCellDP_II : XCell
    {
        public XCellDP_II(Layer layer) : base(layer) { }
        ...
        public override void ActivateOutputChannelsAndGenerateOutputValue()
        {
            ...
            ListOfOutputChannels[0].PatternToSendToAnXCell = ((DIFUSSOR_II_Layer)Layer).PatternToSendInOutputChannels;
        }
