...
namespace GUIXudon.Controls
{
    public class CubeBuilder : ModelBuilder
    {
        ...
        public ModelVisual3D CreateCube()
        {
            return CreateCube(0, 0, 0, 5);
        }

        public ModelVisual3D CreateCube(int x, int y, int z, int side)
        {
        ...
        public void CreateCube(int x, int y, int z, int side, Model3DGroup group)
        {
            Point3D p0 = new Point3D(0 + x, 0 + y, 0 + z);
            Point3D p1 = new Point3D(side + x, 0 + y, 0 + z);
            Point3D p2 = new Point3D(side + x, 0 + y, side + z);
